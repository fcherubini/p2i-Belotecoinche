// page classement affichant le podium et la liste des joueurs triés par score décroissant
...
// composant classement : récupère les profils triés par score et affiche le podium puis le classement complet
